      ...
      <div id="wrapper">
         ...
         <div class="topbar">
            ...
            <div class="topbar-left">
               <a href="index.html" class="logo"><span><img src="assets/images/logo.png" alt="Falcon Logo" title="Goto Main Dashboard"></img></span><i class="mdi mdi-layers"></i></a>
            </div>
                        ...
                        <div class="card-box table-responsive">
                           <div class="clearfix">
                              ...
                              <div class="btn-group m-b-10 col-md-3 float-right">
                                 <button type="button" class="btn btn-info waves-effect" onclick="window.location='<?php echo $previousurl?>';" <?php if($prevdisable){echo "disabled";}?>>Previous Job</button>
                                 <button type="button" class="btn btn-info waves-effect" onclick="window.location='<?php echo $nexturl?>';"<?php if($nextdisable){echo "disabled";}?>>Next Job</button>
                              </div>
                           </div>
